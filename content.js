...
CONTENT.uk = {
  ...
  tabs: { plasma:'Плазма', laser:'Лазер', water:'Воднострумінь', oxy:'Кисень', mill:'Фрезерування', common:'Спільне', faults:'Несправності', gloss:'Словник', iv:'Співбесіда' },
...
CONTENT.sk = {
  ...
  tabs: { plasma:'Plazma', laser:'Laser', water:'Vodný lúč', oxy:'Autogén', mill:'Frézovanie', common:'Spoločné', faults:'Poruchy', gloss:'Slovník', iv:'Pohovor' },
...
CONTENT.en = {
  ...
  tabs: { plasma:'Plasma', laser:'Laser', water:'Waterjet', oxy:'Oxy-fuel', mill:'Milling', common:'Common', faults:'Faults', gloss:'Glossary', iv:'Interview' },
